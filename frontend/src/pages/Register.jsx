...
export default function Register() {
    ...
    return (
        ...
        <div className="w-full max-w-md bg-white/60 backdrop-blur-xl rounded-[40px] shadow-2xl border border-white/40 p-10 relative z-10">
            ...
            Register to manage visitors, passes and appointments
            </p>
            ...
            <select
                ...
                value={formData.role}
                onChange={handleChange}
                className="w-full bg-gray-100/80 rounded-2xl py-4 px-4 outline-none focus:ring-2 focus:ring-blue-400 transition"
            >
